...
<main class="page-main">
    ...
    <div id="mainSliderWrapper">
      ...
      <div id="mainSlider">
        <div class="slide mask">
          <div class="img--holder" style="background-image: url(assets/images/slider/slide-1.jpg);"></div>
        ...
        <div class="slide mask">
          <div class="img--holder" style="background-image: url(assets/images/slider/slide-2.jpg);"></div>
          <div class="slide-content center">
            <div class="vert-wrap container">
              <div class="vert">
                <div class="container">
        ...
        <div class="slide mask">
          <div class="img--holder" style="background-image: url(assets/images/slider/slide-3.jpg);"></div>
          <div class="slide-content center">
            <div class="vert-wrap container">
              <div class="vert">
                <div class="container">
  ...
  <!-- /Services block -->
  <!-- About Us block -->
  <div class="block fullwidth-bg bg-cover inset-lg-3 pb-xs-0 block-1" data-bg="assets/images/block-bg-1.jpg">
    <div class="container">
      ...
      <div class="img-right-wrap">
        <img src="assets/images/content/index-right-img.png" alt="">
      </div>
    </div>
  </div>
  <!-- /About Us block -->
    ...
    <div class="container">
      <div class="row row-revert-xs">
        <div class="col-sm-5 col-md-5 col-lg-6">
          <img src="assets/images/content/index-img-1.jpg"
            class="img-responsive visible-lg visible-md hidden-sm visible-xs" alt="">
          <img src="assets/images/content/index-img-1-mobile.jpg"
      ...
      <div class="testimonials-carousel">
        <div class="testimonial-item">
          ...
          <div class="testimonial-item-author">
            <img src="assets/images/content/testimonial-author-1.png" alt="">
        ...
        <div class="testimonial-item">
          ...
          <div class="testimonial-item-author">
            <img src="assets/images/content/testimonial-author-2.png" alt="">
      ...
      <div class="news-carousel row">
          ...
          <div class="news-prw">
            <div class="news-prw-image">
              <a href="blog-post-page.html">
                <img src="assets/images/content/news-img-1.jpg" alt="">
        ...
        <div class="col-sm-4">
          <div class="news-prw">
            <div class="news-prw-image">
              <a href="blog-post-page.html">
                <img src="assets/images/content/news-img-2.jpg" alt="">
                <span><i class="icon-link"></i></span>
              </a>
            </div>
        ...
        <div class="col-sm-4">
          <div class="news-prw">
            <div class="news-prw-image">
              <a href="blog-post-page.html">
                <img src="assets/images/content/news-img-3.jpg" alt="">
                <span><i class="icon-link"></i></span>
              </a>
            </div>
  ...
  <!-- /News block -->
  <!-- Facts block -->
  <div class="block fullwidth-bg inset-lg-1 bg-cover js-bg-parallax" data-bg="assets/images/block-bg-5.jpg">
    <div class="container">
  ...
  <div class="block m-bottom-45">
    <div class="container">
      <div class="row row-revert-xs">
        <div class="col-sm-6">
          <div class="img-left-wrap1"><img src="assets/images/content/index-img-2.jpg" class="img-responsive" alt="">
          </div>
        </div>
        <div class="col-sm-6">
